 ...
 *
 * Every seeded employee gets one pending request aged 47h54m so the scheduled
 * expire command will flip it ~6 minutes after a fresh docker compose up (demo video).
 */
class PaymentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $almostExpiredAt = Carbon::now()->subHours($expirationHours)->addMinutes(6);
        $sequence = 1001;
